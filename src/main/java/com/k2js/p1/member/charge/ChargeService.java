...
public class ChargeService {
	...
	public String kakaoPayReady(HttpSession session, int money) {
		...
		params.add("approval_url", "http://localhost:8081/p1/member/charge/Success?money=" + money);
		params.add("cancel_url", "http://localhost:8081/p1/member/charge/Cancel");
		params.add("fail_url", "http://localhost:8081/p1/member/charge/Fail");
